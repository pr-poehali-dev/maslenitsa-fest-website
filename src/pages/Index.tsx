...
const Index = () => {
  const programItems = [
    {
      emoji: "✨",
      title: "Главное приключение: Семейный квест «Дорога к Весне»",
      description:
        "Не просто станции, а 6 шагов к обновлению. На входе каждая семья получит волшебный буклет-путеводитель. Вместе с героями сказок вы выполните задания на ловкость, смекалку и взаимопомощь на пути к главному ритуалу — созданию семейного оберега и Древа Желаний. Пройдите весь путь — получите памятный символ года!",
    },
    {
      emoji: "🎨",
      title: "Творчество и ремесло: Тёплые Мастерские",
      description:
        "В нашем уютном творческом павильоне вас ждут мастер-классы от талантливых мастеров и партнёров: куклы-Масленицы, роспись пряников, народная игрушка из дерева, создание свечей. Увезите с собой не просто сувенир, а частичку тепла, сделанную своими руками.",
    },
    {
      emoji: "🛍️",
      title: "Ярмарка с душой: Подарки для дома и семьи",
      description:
        "В ярмарочном павильоне — только отборные товары от проверенных мастеров и локальных производителей: авторская керамика, вязаные вещи, натуральные сладости, домашний декор и игрушки. Всё, что создаёт атмосферу уюта и праздника в вашем доме.",
    },
    {
      emoji: "🍯",
    ...
    },
    {
      ...
      description:
        "Прокат коньков, лыж и тюбингов! (При благоприятной погоде). Весёлые старты, хороводы вокруг чучела Масленицы и большая праздничная лотерея с ценными призами от наших партнёров!",
    },
  ];
  ...
  const takeaways = [
    ...
    },
    {
      ...
      description:
        "Куколку-Масленицу и браслет желаний, созданные вашими руками.",
    },
    {
      icon: "Sparkles",
      title: "Намерение на год",
      description: "Цветная лента на общем Древе Желаний парка.",
    },
    {
      icon: "Gift",
      title: "Памятный символ",
      description: "Уникальный сувенир в завершение квеста.",
    },
    {
      icon: "Users",
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Вход на территорию, участие в квесте и всех активностях (кроме платных мастер-классов от партнёров и проката инвентаря). Билеты можно приобрести или на входе.",
    },
  ];
