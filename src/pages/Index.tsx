...
const Index = () => {
  const programItems = [
    ...
    },
    {
      ...
      description:
        "В нашем уютном творческом павильоне вас ждут мастер-классы от талантливых мастеров и партнёров: куклы-Масленицы, роспись пряников и многое другое. Увезите с собой не просто сувенир, а частичку тепла, сделанную своими руками.",
    },
    {
      emoji: "🛍️",
  ...
  const takeaways = [
    {
      icon: "Heart",
      title: "Опыт единения",
      description: "Чувство единения, радости, сплоченности и яркие впечатления от пути пройденного вместе.",
    },
    {
      icon: "Star",
